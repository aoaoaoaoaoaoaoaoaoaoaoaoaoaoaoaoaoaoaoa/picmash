...
pub(super) struct SessionField {
    ...
    pub(super) hierarchical_assets: HashMap<AssetId, HierarchicalAssetPosterior>,
    pub(super) dominant_faces: HashMap<AssetId, FaceIdentityRecord>,
    pub(super) hierarchical_session: Option<HierarchicalSessionPosterior>,
    pub(super) perturbative_assets: HashMap<AssetId, PerturbativeAssetPosterior>,
